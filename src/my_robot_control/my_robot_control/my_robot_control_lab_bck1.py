...
class RobotController(Node):
    ...
    def process_lidar_data(self):
        ...
        if self.lidar_data:
            ...
            front_angle_min = -3.1416 / 4  # 45 degrees to the left
            front_angle_max = 3.1416 / 4   # 45 degrees to the right
            min_angle_idx = int((front_angle_min + 3.1416) / (2 * 3.1416) * len(self.lidar_data))
            max_angle_idx = int((front_angle_max + 3.1416) / (2 * 3.1416) * len(self.lidar_data))
